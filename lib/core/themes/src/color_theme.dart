...
class AppColors {
  Color appPrimary = const Color(0xFF393646);
  Color appSecondary = const Color(0xFF4F4557);
  Color appTertiary = const Color(0xFF6D5D6E);
  Color appQuaternary = const Color(0xFFF0E3E3);
